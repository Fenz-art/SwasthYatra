...
export default function PricingSection() {
  ...
  return (
    <section id="pricing" className="py-section bg-canvas" ref={ref}>
            ...
            >
              {tier.featured && (
                <div className="absolute -top-3 left-1/2 -translate-x-1/2">
                  <span className="inline-flex items-center gap-1 px-3 py-1 rounded-full bg-accent-cyan-soft text-accent-cyan text-caption-sm font-medium">
              ...
              <div className="mb-6">
                <h3 className="text-heading-xl text-ink mb-1">{tier.name}</h3>
                <p className="text-body-sm text-mute">{tier.description}</p>
              </div>

              <div className="flex items-baseline gap-1 mb-6">
                <span className="text-display-lg text-ink">{tier.price}</span>
                <span className="text-body-sm text-mute">{tier.period}</span>
              </div>
